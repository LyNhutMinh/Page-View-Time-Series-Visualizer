...
# Clean data
# Filtering out days when the page views were in the top 2.5% or bottom 2.5%
df = df[
...
def draw_bar_plot():
    ...
    df_bar_group = df_bar_group.reindex(columns=months)

    # Draw bar plot
    fig = df_bar_group.plot(kind='bar', figsize=(10, 8)).figure
    plt.xlabel('Years')
...
def draw_box_plot():
    ...
    # Month-wise Box Plot
    # Order the months correctly starting from Jan
